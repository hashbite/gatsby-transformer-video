...
// export type CreateFromProfileArgs<T extends DefaultTransformerFieldArgs> = T & {
//   profile: string
// }
...
export interface DefaultProfileArgs {
  profile: string
  ffmpegSession: FfmpegCommand
  filters: string[]
  videoStreamMetadata: VideoStreamMetadata
...
export interface ScreenshotTransformerHelpers extends Actions, NodePluginArgs {}
